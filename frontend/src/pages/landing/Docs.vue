...
.doc-cta { display: inline-block; margin-top: 16px; padding: 10px 24px; background: var(--gradient-brand); border-radius: 10px; font-weight: 600; transition: transform 0.2s; }
