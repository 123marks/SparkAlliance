...
const expandFeatures = [
  ...
  { title: '学长导师', desc: '经验分享、一对一咨询、学业规划指导', status: 'live', statusText: '已上线', to: '/app/mentors', iconBg: 'rgba(139,92,246,0.12)', svg: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" stroke-width="2"><path d="M22 10v6M2 10l10-5 10 5-10 5z"></path><path d="M6 12v5c3 3 9 3 12 0v-5"></path></svg>' },
  { title: '校园购物', desc: 'C2C 二手交易、近距离优先推送、交易保障', status: 'live', statusText: '已上线', to: '/app/shop', iconBg: 'rgba(249,115,22,0.12)', svg: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f97316" stroke-width="2"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>' },
...
const futureFeatures = [
  { title: '星火自习室', to: '/app/study-room', statusText: '已上线', badgeClass: 'live', iconBg: 'rgba(16,185,129,0.12)', svg: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>' },
